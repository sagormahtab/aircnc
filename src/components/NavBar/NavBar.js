    ...
    return (
        <div>
            <MDBNavbar color="white" light expand="md">
                <MDBContainer>
                <MDBNavbarBrand>
                <Link to="/"><strong className="nav-logo"><span style={{color:'#2bde8c'}}>A</span><span style={{color: '#3de27e'}}>i</span><span style={{color: '#4fe66f'}}>r</span><span style={{color: '#62ea61'}}>c</span><span style={{color: '#74ee52'}}>n</span><span style={{color: '#86f244'}}>c</span></strong></Link>
                </MDBNavbarBrand>
